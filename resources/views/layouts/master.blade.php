 ...
 <!-- Portfolio Section-->
  @yield('content')
   ...
   @include('includes.footer')
        ...
        <script src="{{URL::asset('https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.bundle.min.js')}}"></script>
        <!-- Third party plugin JS-->
        <script src="{{URL::asset('https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js')}}"></script>
        <!-- Contact form JS-->
